...
from objectfs.core.cache.cachetask import download_object_block, upload_object_block, prefetch_object_block, multipart_upload_object_block, merge_log_objects
...
class CacheQueue(object):
    ...
    def enqueue_upload_task(self, inode_id, object_block_id):
        logger.debug("Enqueueing upload task for inode {} object-block {}".format(inode_id, object_block_id))
        return self._queue.enqueue_call(func=upload_object_block, args=(self._fs_name, inode_id, object_block_id))
